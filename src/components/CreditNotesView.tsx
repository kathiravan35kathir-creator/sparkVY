    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl border p-4 flex gap-3 shadow-sm">
        <div className="relative flex-1">
          ...
          <input type="text" placeholder="Search credit notes..." value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)} className="w-full bg-slate-50 border rounded-lg pl-9 pr-4 py-2 text-xs focus:bg-white focus:outline-none transition-all" />
        </div>
      </div>
